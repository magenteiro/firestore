...
class Street extends \Magento\Customer\Block\Widget\AbstractWidget
{
    ...
    /**
     * Create an instance of the street widget
     *
     * @param Helper $helper
    ...
    /**
     * Check if number attribute enabled in system
     * @return bool
     */
    ...
    /**
     * Check if complement attribute enabled in system
     * @return bool
     */
    ...
    /**
     * Check if neighborhood attribute enabled in system
     * @return bool
     */
