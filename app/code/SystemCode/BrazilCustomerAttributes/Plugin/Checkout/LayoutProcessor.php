...
class LayoutProcessor
{
    ...
    public function getShippingFormFields($jsLayout, $numStreetLines)
    {
        ...
        // Street Line 3
        if($this->helper->getConfig("brazilcustomerattributes/general/line_complement") && $numStreetLines >= 3) {
            $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ['shippingAddress']['children']['shipping-address-fieldset']['children']['street']['children'][2]['label'] = __('Complement');
            $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ['shippingAddress']['children']['shipping-address-fieldset']['children']['street']['children'][2]['validation'] = ['required-entry' => false, "max_text_length" => 255];
        }

        // Street Line 4
        if($this->helper->getConfig("brazilcustomerattributes/general/line_neighborhood") && $numStreetLines == 4) {
            $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ['shippingAddress']['children']['shipping-address-fieldset']['children']['street']['children'][3]['label'] = __('Neighborhood');
            $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
            ['shippingAddress']['children']['shipping-address-fieldset']['children']['street']['children'][3]['validation'] = ['required-entry' => true, "min_text_lenght" => 3, "max_text_length" => 255];
        }
        ...
        if(isset($jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children']['payments-list'])
            ...
            foreach ($paymentForms as $paymentMethodForm => $paymentMethodValue) {
                ...
                if($this->helper->getConfig("brazilcustomerattributes/general/line_number") && $numStreetLines >= 2) {
                    ...
                    $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']
                    ['children']['payment']['children']['payments-list']['children'][$paymentMethodCode . '-form']
                    ['children']['form-fields']['children']['street']['children'][1]['validation'] = ['required-entry' => true, "min_text_length" => 1, "max_text_length" => 255];
                }
                ...
                if($this->helper->getConfig("brazilcustomerattributes/general/line_neighborhood") && $numStreetLines >= 4) {
                    ...
                    $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']
                    ['children']['payment']['children']['payments-list']['children'][$paymentMethodCode . '-form']
                    ['children']['form-fields']['children']['street']['children'][2]['validation'] = ['required-entry' => true, "min_text_length" => 1, "max_text_length" => 255];
                }
